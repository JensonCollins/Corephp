                                      ...
                                      if (empty($page_value)) {?>   
                                            ...
                                            <div class="col-lg-10 col-md-12 col-sm-12 col-xs-12">
                                                <table id="datatable" class="table table-striped table-bordered dataTable no-footer" role="grid" aria-describedby="datatable_info">
                                                  <thead>
                                                     <tr role="row">
                                                        <th class="" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" >ID</th>
                                                        <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" width="170px" >Date</th>
                                            ...
                                            <div class="col-lg-2 col-md-12 col-sm-12 col-xs-12">
                                               <div class="row gutter">
                                                  ...
                                                  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                     <div class="panel no-border yellow-bg">
                                                        <div class="panel-body text-center">
                                                           <div class="user-stats" style="padding: 10px; background: #b8ce3c; color: #fff;">
                                                              <a href="<?php echo base_url();?>support/new"><h2>OPEN TICKET</h2></a>
                                                           </div>
                                                        </div>
                                                     </div>
                                                  </div>
                                                  ...
                                                  <div class="col-lg-12 col-md-3 col-sm-3 col-xs-6">
                                                     <div class="panel no-border green-bg">
                                                        <div class="panel-body text-center">
                                                     ...
                                                     <div class="panel-body">
                                                        <form id="movieForm" method="post">
                                                           ...
                                                           <div class="form-group">
                                                              <div class="row gutter">
                                                                 <div class="col-md-12">
                                                                  <label class="control-label">Your Name</label><input disabled="disabled" type="text" placeholder="<?php echo $user_data['user_name']; ?>" class="form-control" name="title">
                                                                </div>                                       
                                                              </div>
                                                           </div>
                                                                ...
                                                                <div class="row gutter">
                                                                    <div class="col-md-12">
                                                                      <label class="control-label">Reason</label>
                                                                       <textarea placeholder="Write reason" class="form-control" name="reason" rows="5"></textarea>
                                                                   </div>
                                                               </div>
                                                         </div>
                                                           <button type="submit" name="add_ticket" class="btn btn-info">Submit</button>
                                                        </form>
                                                     </div>
                                                  </div>
                                               </div>
                                                                              ...
                                                                              <div class="panel">
                                                                                 ...
                                                                                 <div class="panel-body">
                                                                                    <form id="movieForm" method="post">
                                                                                       <div class="form-group">
                                                                                          <div class="row gutter">
                                                                                             <div class="col-md-8"><label class="control-label">Your Name</label><input disabled="disabled" type="text" placeholder="<?php echo $user_data['user_name']; ?>" class="form-control" name="title"></div>                                       
                                                                                          </div>
                                                                                       </div>
                                                                                       
                                                                                       
                                                                                       <div class="form-group"><label class="control-label">Comment</label>
                                                                                       <textarea placeholder="Write reason" class="form-control" name="comment" rows="5"></textarea></div>
                                                                                       
                                                                                       <button type="submit" name="replay_ticket" class="btn btn-info">Submit</button>
                                                                                    </form>
                                                                                 </div>
                                                                              </div>
                                                                           </div> 
