                ...
                <div class="panel no-border">
                    <div class="panel-body milky-white-bg ">
                        ...
                        <?php if (!empty($amount)) { ?>
                            ...
                            $PAYEE_ACCOUNT = $settings['pm_payee_account'];
                            $PAYEE_NAME = $settings['pm_payee_name'];
                            ?>

                            <center>
                                <form id="pay" action="https://perfectmoney.is/api/step1.asp" method="POST" name="Pay"
                                    ...
                                    <input type="hidden" name="PAYMENT_URL"
                                           value="<?php echo base_url(); ?>pm/thankyou">
                                    ...
                                    <button class="btn btn-danger center-text" type="submit" name="PAYMENT_METHOD">Pay
                                        ($<?php echo $amount; ?>)
                                    </button>
                                </form>
                            </center>
