...
if (isset($_POST['add'])) {
    ...
    if ($price < 0.9) {
        echo alert('<center><strong>Limit for te price is 1$</strong></center>', 'warning');
        die('<meta http-equiv="refresh" content="3;" />');
    }


    if (empty($basefile) || empty($price) || empty($category)) {
                        ...
                        <form method="POST" action="">
                            <div class="modal-body">
                                ...
                                <div class="form-group" style="width: 30%">
                                    ...
                                    <input type="number" name="price" class="form-control" id="recipient-name" value="5"
                                           required>
                                </div>
                                ...
                                <div class="form-group">
                                    <label for="recipient-name" class="control-label">SMTP :
                                        Server:Port,email,password</label><br>
                                    <label for="recipient-name" class="control-label">Leads: Url ,descript
                                        ,amount</label>


                                    <textarea name="value" class="form-control" id="message-text" style="height: 150px"
