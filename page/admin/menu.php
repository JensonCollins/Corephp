            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h3><strong class="card-title">Menu Management </strong></h3>
                    </div>
                    <div class="card-body">
                        ...
                        <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                            ...
                            $sql = $db->query("SELECT * FROM `menu`") or die();
                            ...
                            while ($row = $sql->fetch_assoc()) {
                                ...
                                echo '<tr>
                                        ...
                                        <td class="sorting_1" >' . clear($row["parent_id"]) . '</td>
                                        <td class="sorting_1" >' . clear($row["menu_name"]) . '</td>
                                        <td class="sorting_1" >' . clear($row["menu_type"]) . '</td>
                                        <td class="sorting_1" >' . clear($row["menu_icon"]) . '</td>
                                        <td class="sorting_1" >' . clear($row["menu_title"]) . '</td>
                                        <td class="sorting_1" >' . clear($row["menu_link"]) . '</td>
                                        <td class="sorting_1" >' . clear($row["visible"]) . '</td>
                                      </tr>';
                            }
                            ?>
                            </tbody>
