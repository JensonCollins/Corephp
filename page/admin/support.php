                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Support ADMIN </strong>
                            </div>
                            <div class="card-body">
                              ...
                              <?php if (empty($page_id)) {?>   
                                ...
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                     <thead>
                                       <tr role="row">
                                          <th class="" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" width="70px">ID</th>
                                          <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" width="70px" >user_name</th>
                                          ...
                                          <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" >View</th>
                                       </tr>
                                    </thead>
                                                                                              ...
                                                                                              <?php echo '<p  style="float:right;margin-bottom: -26px;"> '.$show_button.'</p> '; ?>
                                                                                               ...
                                                                                               <form class="form-horizontal" role="form">
                                                                                                ...
                                                                                                <div class="form-group">
                                                                                                      ...
                                                                                                      <input type="text" class="form-control" readonly="readonly" value="ID: <?php echo clear($accounts['item_id']); ?> | Buyer: <?php echo clear($accounts['buyer']); ?> | Price: <?php echo $accounts['price'] ?>$">
                        ...
                        <div class="panel">
                           ...
                           <div class="panel-body">
                              <form  method="post">
                                 <div class="form-group">
                                    <div class="row gutter">
                                       <div class="col-md-12"><label class="control-label">Your Name</label><input disabled="disabled" type="text" placeholder="ADMIN" class="form-control" name="title"></div>                                       
                                    </div>
                                 </div>
                                 
                                 
                                 <div class="form-group"><label class="control-label">Mesage</label>
                                 <textarea placeholder="Write reason" class="form-control" name="message" rows="5"></textarea></div>
