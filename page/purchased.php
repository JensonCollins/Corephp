                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="alert alert-danger" role="alert">
                                              ...
                                              <p>If we find out you have reported a valid tool, we shall clear your account funds and or disable your account.</p>
                                              <hr>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Purchased</strong>
                            </div>
                            <div class="card-body">
                                  ...
                                  if (isset($_POST['item_id'])) {
                                              ...
                                              $diff = strtotime($now_date) - strtotime($purchase_data);
                                                        ...
                                                        ?>
                                                              ...
                                                              <div class="col-sm-8">
                                                               ...
                                                               <strong> <p>If you are sure to report this tool, please explain the problem.</p></strong>                                 

                                                                    <form class="form-horizontal" action="" method="post">
                                                                     <input type="hidden" name="id" value="<?php echo enc($item_id); ?>"> 
                                                                     <div class="form-group">                                  
                                                                      <div class="col-md-10">
                                                                      <textarea name="message" class="form-control" rows="10" placeholder="Explain the problem"></textarea></div>
                                                                      <br>
                                                                    </div> <br>
                                                                        ...
                                                                        <div class="form-group">                                       
                                                                          <div class="col-md-10">
                                                                             <br>
                                                                            <button type="submit" name="tickets" class="btn btn-success waves-effect waves-light">REPORT IT</button>

                                                                               <a href="<?php echo base_url();?>">
                                                                                <div type="button" name="tickets" class="btn btn-danger waves-effect waves-light">Cancel</div></a>
                                                                          </div>
                                                                        </div>
                                                                            ...
                                                                            ?>
                                                                                              ...
                                                                                              <?php echo '<p  style="float:right;margin-bottom: -26px;"> '.$show_button.'</p> '; ?>
                                                                                               ...
                                                                                               <form class="form-horizontal" role="form"> 
                                                                                                ...
                                                                                                <div class="form-group">
                                                                                                     Contry: <?php echo ($accounts["country"]);  ?> | <?php echo flag($accounts["country"]);  ?>                                  
                                                                                                  </div>                                                                                              
                                                                                             
                                                                                                 <div class="form-group">
                                                                                                     Info:<br>
                                                                                                     <input type="text" class="form-control" readonly="readonly" value="<?php echo replace_kredencial($accounts['info']);  ?>">
                                                                                                  </div>

                                                                                                 
                                                                                                  <div class="form-group">
                                                                                                     login:<br>
                                                                                                     <input type="text" class="form-control" readonly="readonly" value="<?php echo replace_kredencial(trim($accounts['login']));?>">

                                                                                                  </div>

                                                                                                  <div class="form-group">
                                                                                                     Password:<br>
                                                                                                     <input type="text" class="form-control" readonly="readonly" value="<?php echo replace_kredencial(trim($accounts['pass']));?>">
                                                                                                  </div>

                                                                                                    <div class="form-group">
                                                                                                     Host:<br>
                                                                                                     <input type="text" class="form-control" readonly="readonly" value="<?php echo replace_kredencial(trim($accounts['addinfo']));?>">
                                                                                                  </div>
                                                                                               </form>
                                   ...
                                   if ($page_value == null) {
                                    ...
                                    ?>
                                     ...
                                     <table id="bootstrap-data-table-export" class="table table-striped table-bordered dataTable no-footer" role="grid" aria-describedby="datatable_info" style="width: 100%;">
                                       <thead>
                                        <tr role="row">
                                           <th class="no-sort" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" width="100px">ID</th>
                                         <th class="no-sort" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" >Type</th>
                                         <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" >Info</th>
                                         <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" >Login</th>
                                         <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" >Pass</th>
                                         <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" >URL</th>
                                         <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" >Price</th>
                                         <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" >REPORT </th>
                                       </tr>
                                     </thead>
